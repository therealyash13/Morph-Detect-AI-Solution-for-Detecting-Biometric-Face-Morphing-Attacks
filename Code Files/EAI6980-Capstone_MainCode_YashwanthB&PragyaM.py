...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_csv_path", default=r"C:\Users\User\OneDrive\Desktop\INT 6980 Research\SMDD-Synthetic-Face-Morphing-Attack-Detection-Development-dataset-main\SMDD_Train_Data\train.csv", type=str, help="input path of train csv")
    parser.add_argument("--test_csv_path", default=r"C:\Users\User\OneDrive\Desktop\INT 6980 Research\SMDD-Synthetic-Face-Morphing-Attack-Detection-Development-dataset-main\SMDD_Test_Data\evaluation_crop.csv", type=str, help="input path of test csv")
